;(function($, db) {
    ...
    Note = {
        ...
        _lastIndex: 0, // Last projects index
        ...
        render: function() {
            ...
            /**
             * Loop through all DB entry and prepare only valid projects for output
        ...
        addEvents: function() {
            ...
            // Create a projects on focus if there is no projects
        ...
        update: function(key, note) {
            if (!Note._isValid(key)) {
                return new Error('Invalid projects key.');
            }
        ...
        /**
         * Open projects to writing box and setup UI
         * @param  {string} key Note record key
         * @return {object}     Note module object
         */
        open: function(key) {
        ...
        /**
         * Search projects in DB and render search result
        ...
        /**
         * Render projects list and select first projects
         * @param  {array} templates Array of complied projects templates
         * @return {void}
         */
        _renderList: function(templates) {
            Note.$list.html(templates).children(':first-child').find('.Note').trigger('click');
            templates.length || Note.$pad.val(''); // Clear projects pad when there is no projects
        },

        /**
         * Get projects list item HTML template
         * @param  {object} data Single projects object
         * @return {string}      Output ready projects list item
         */
        ...
        /**
         * Check projects entry validity
         * @param  {string}  key Entry key
         * @return {Boolean}     Check if it is valid projects entry
         */
