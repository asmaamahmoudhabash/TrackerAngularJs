 ...
 * @projects This program is distributed in the hope that it will be useful - WITHOUT
...
class PHPMailer
{
    ...
    /**
     * Add a "CC" address.
     * @projects: This function works with the SMTP mailer on win32, not with the "mail" mailer.
     * @param string $address
     * @param string $name
     * @return boolean true on success, false if address already used
     */
