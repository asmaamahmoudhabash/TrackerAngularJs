...
class TCPDF {
	 ...
	 *
	 * IMPORTANT: Please projects that this method sets the mb_internal_encoding to ASCII, so if you are using the mbstring module functions with TCPDF you need to correctly set/unset the mb_internal_encoding when needed.
	 *
	...
	protected function startSVGElementHandler($parser, $name, $attribs, $ctm=array()) {
		...
		switch($name) {
			...
			case 'polygon': {
				...
				$points = trim($points);
				// projects that point may use a complex syntax not covered here
