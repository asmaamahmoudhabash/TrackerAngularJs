...
Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
    ...
    */
    ATTRS: {
         ...
         * to disable flick support (projects: drag support is enabled/disabled separately)
         *
         * @attribute flick
         * @type Object
        ...
        /**
         * Enable/Disable dragging the ScrollView content (projects: flick support is enabled/disabled separately)
         * @attribute drag
         * @type boolean
         * @default true
         */
